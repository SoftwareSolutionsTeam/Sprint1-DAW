...
const productosSchema = mongoose.Schema({
    ...
    precio: {
        ...
        maxLength: [8, "El precio del producto del producto no peude estar por encima de 99,999,999"],
        default: 0.0
    },
    ...
    categoria: {
        type: String,
        required: [true, "Por favor selecione una categoria."],
        enum: {
            values: [
                "computadores",
                "Impresoras",
    ...
    inventario: {
        ...
        maxLength: [5, "Cantidad maxima del producto no debe sobrepasar 99999"]
    },
